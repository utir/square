...
% loadStatisticsData creates a stats data struct from the evaluation directory --
% directory structure is fixed
% Inputs:
%  nFoldEvalDir is the path to the evaluation directory
%  eg:/Users/aashish/dev/java/crwdQA/crowdData/nFoldSets/nFoldSet_05
% Outputs:
%  stats is the resultant object  
% *********************************************************************
