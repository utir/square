function perDatasetResultsSynthTEX(resultsDir,metric,datasetColIdx,saveDir)
% perDatasetResultsSynthTEX generates Latex files with mean performance for the given metric
% (Synthethic-Data)
% Inputs:
