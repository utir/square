function perDatasetResultsReal(resultsDir,metric,datasetColIdx,saveDir)
% perDatasetResultsReal generates _results.csv files with mean performance
% for the given metric (Real-Data)
% Inputs:
...
% **********************************************************************
    ...
    coloumnName = {'Method','Type','10%','20%','50%','80%','90%'};    
    coloumnNameMatch = {'10','20','50','80','90'};
