function printFileInvocationEvalRealSupervised(file)
% printFileInvocationEvalRealSupervised prints invocation for the SQUARE
% algorithms configured to run supervised on real data
% Inputs:
%   file -
% eg:
% /Users/aashish/dev/java/crwdQA/crowdQA_Algorithms/evalRealData_supervised_CLA.txt
% **************************************************************************
    fid = fopen(file,'w');
