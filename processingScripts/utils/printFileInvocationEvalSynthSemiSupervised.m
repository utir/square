function printFileInvocationEvalSynthSemiSupervised(file)
% printFileInvocationEvalSynthSemiSupervised prints invocation for the SQUARE
% algorithms configured to run semi-supervised on synthetic data
% Inputs:
%   file -
% eg:
% /Users/aashish/dev/java/crwdQA/crowdQA_Algorithms/evalSynthData_semisupervised_CLA.txt
% **************************************************************************
    fid = fopen(file,'w');
