function printFileInvocationEvalRealSemiSupervised(file)
% printFileInvocationEvalRealSemiSupervised prints invocation for the SQUARE
% algorithms configured to run semi-supervised on real data
% Inputs:
%   file -
% eg:
% /Users/aashish/dev/java/crwdQA/crowdQA_Algorithms/evalRealData_semisupervised_CLA.txt
% **************************************************************************
    fid = fopen(file,'w');
